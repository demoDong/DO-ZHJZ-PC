...
import { DoEchartsService } from '../do-echarts/do-echats.service';
...
export class DoEchartsComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  @Output() chartLegendselected: EventEmitter<any> = new EventEmitter<any>();
  ...
  public onChartLegendselected(e) {
