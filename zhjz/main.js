...
/* harmony import */ var primeng_carousel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! primeng/carousel */ "./node_modules/primeng/carousel.js");
/* harmony import */ var primeng_carousel__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(primeng_carousel__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shared/shared.module */ "./src/app/shared/shared.module.ts");
/* harmony import */ var _shared_do_echarts_do_echarts_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./shared/do-echarts/do-echarts.module */ "./src/app/shared/do-echarts/do-echarts.module.ts");
/* harmony import */ var primeng_tree__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! primeng/tree */ "./node_modules/primeng/tree.js");
/* harmony import */ var primeng_tree__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(primeng_tree__WEBPACK_IMPORTED_MODULE_10__);
...
/* harmony import */ var _pages_my_projects_todo_my_projects_todo_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./pages/my-projects-todo/my-projects-todo.component */ "./src/app/pages/my-projects-todo/my-projects-todo.component.ts");
...
/* harmony import */ var _shared_services_http_api_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./shared/services/http-api.service */ "./src/app/shared/services/http-api.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _pages_my_projects_todo_my_projects_todo_component__WEBPACK_IMPORTED_MODULE_19__["MyProjectsTodoComponent"],
            ...
            imports: [
                ...
                _shared_do_echarts_do_echarts_module__WEBPACK_IMPORTED_MODULE_9__["DoEChartsModule"],
                primeng_tree__WEBPACK_IMPORTED_MODULE_10__["TreeModule"],
            ],
            providers: [_shared_services_http_api_service__WEBPACK_IMPORTED_MODULE_21__["HttpApi"]],
...
/* harmony import */ var _shared_services_http_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../shared/services/http-api.service */ "./src/app/shared/services/http-api.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomepageComponent = /** @class */ (function () {
    ...
    HomepageComponent.prototype.ngOnInit = function () {
        ...
        this.http.get('/ucenter/rest/v2/services/ucenter_ProjectGroupService/getLimitProjectGroups').subscribe(function (data) {
            data.forEach(function (projectGroupItem) {
                projectGroupItem.projects.forEach(function (project) {
                    _this.buildingPorjectsArr.push({
    ...
    HomepageComponent.prototype.scanProjectInformationDetail = function (id) {
    ...
    HomepageComponent.prototype.showBigPic = function (pic) {
        this.bigPic = pic;
    ...
    HomepageComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_link_service__WEBPACK_IMPORTED_MODULE_1__["LinkService"],
            ...
            _shared_services_http_api_service__WEBPACK_IMPORTED_MODULE_4__["HttpApi"]])
    ], HomepageComponent);
...
module.exports = "<app-page-iframe [picture]=\"picture\" [ZH_TITLE]=\"ZH_TITLE\" [EN_TITLE]=\"EN_TITLE\" [NAV_INDEX]=\"NAV_INDEX\">\r\n    <div class=\"h-content-layout\">\r\n        <div class=\"h-content-top\">\r\n            <a [routerLink]=\"['/myProjects']\">我的项目</a>&lt;&lt;<span>待办事项</span>\r\n        </div>\r\n        <ul class=\"h-content-botttom\">\r\n            <li class=\"contentTitle\">\r\n                <h4>待办事项<span>{{allTodoThings.length}}</span></h4>\r\n            </li>\r\n            <li class=\"ui-g\" *ngFor=\"let item of rencentPageTotoThings\">\r\n                <div class=\"ui-g-10\">\r\n                    <div class=\"listDetail\"><span>【任务审批通知】</span><span>{{item.taskState}}</span></div>\r\n                    <div class=\"listMes\"><span>表单编号：{{item.formCode}}</span><span>表单名称：{{item.formName}}</span></div>\r\n                </div>\r\n                <div class=\"ui-g-2 text-center\">\r\n                    <button>马上办理</button>\r\n                    <p>{{item.startTime.split(' ')[0]}}</p>\r\n                </div>\r\n            </li>\r\n        </ul>\r\n        <p-paginator [rows]=\"5\" [totalRecords]=\"allTodoThings.length\" (onPageChange)=onPageChange($event)></p-paginator>\r\n    </div>\r\n</app-page-iframe>"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_services_token_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shared/services/token.service */ "./src/app/shared/services/token.service.ts");
/* harmony import */ var _shared_services_http_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/services/http-api.service */ "./src/app/shared/services/http-api.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyProjectsTodoComponent = /** @class */ (function () {
    function MyProjectsTodoComponent(http, token) {
        this.http = http;
        this.token = token;
    }
    MyProjectsTodoComponent.prototype.ngOnInit = function () {
        ...
        this.NAV_INDEX = 1;
        this.allTodoThings = [];
        this.http.get('/ucenter/rest/v2/services/ucenter_CommonService/findPendingWork', { headers: { 'Authorization': "Bearer " + this.token._token } }).subscribe(function (data) {
            _this.allTodoThings = data;
            _this.rencentPageTotoThings = _this.allTodoThings.slice(0, 5);
        });
    };
    MyProjectsTodoComponent.prototype.onPageChange = function (e) {
    ...
    MyProjectsTodoComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_http_api_service__WEBPACK_IMPORTED_MODULE_2__["HttpApi"], _shared_services_token_service__WEBPACK_IMPORTED_MODULE_1__["TokenService"]])
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _shared_services_token_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/services/token.service */ "./src/app/shared/services/token.service.ts");
/* harmony import */ var _shared_services_http_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../shared/services/http-api.service */ "./src/app/shared/services/http-api.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyProjectsComponent = /** @class */ (function () {
    function MyProjectsComponent(router, http, token) {
        this.router = router;
        this.http = http;
        this.token = token;
        this.projectProduce = {};
    ...
    MyProjectsComponent.prototype.ngOnInit = function () {
        ...
        this.NAV_INDEX = 1;
        this.http.get('/ucenter/rest/v2/services/ucenter_CommonService/findPendingWork', { headers: { 'Authorization': "Bearer " + this.token._token } }).subscribe(function (data) {
            _this.todoThingsNum = data.length;
        });
        // 初始化获取项目列表
        this.http.get('/ucenter/rest/v2/services/ucenter_ProjectGroupService/getProjectGroupsByLogin', { headers: { 'Authorization': "Bearer " + this.token._token } }).subscribe(function (data) {
            data.forEach(function (projectGroupItem) {
                projectGroupItem.projects.forEach(function (project) {
                    ...
                    project.images.forEach(function (imgItem) {
                        buildingProList.data.pics.push(entry + "images?id=" + imgItem.id);
                    });
                    _this.http.get(
                    // tslint:disable-next-line:max-line-length
                    "/ucenter/rest/v2/services/ucenter_ProjectGroupService/findUserDuty?projectUrl=" + entry + "&projectId=" + id, { headers: { 'Authorization': "Bearer " + _this.token._token } }).subscribe(function (result) {
                        result.forEach(function (buildingItem) {
                    ...
                    _this.projects.building.push(buildingProList);
                });
            });
            _this.projectProduce = _this.projects.building[0].data;
        });
    };
    ...
    MyProjectsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _shared_services_http_api_service__WEBPACK_IMPORTED_MODULE_3__["HttpApi"], _shared_services_token_service__WEBPACK_IMPORTED_MODULE_2__["TokenService"]])
    ], MyProjectsComponent);
...
module.exports = "<app-page-iframe [picture]=\"picture\" [ZH_TITLE]=\"ZH_TITLE\" [EN_TITLE]=\"EN_TITLE\" [NAV_INDEX]=\"NAV_INDEX\" class=\"personalCenter\">\r\n    <ul class=\"h-content-layout\">\r\n        <li>\r\n            <span>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;户：</span>\r\n            <input type=\"text\" [(ngModel)]=\"allMes['user']['_instanceName']\" readonly></li>\r\n        <li>\r\n            <span>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</span>\r\n            <input type=\"text\" [(ngModel)]=\"name\" [readonly]=\"isNameReadonly\" id=\"name\" [ngClass]=\"{'edit': isEdits[0]}\">\r\n            <button (click)=\"onClickResetName()\">修改</button>\r\n        </li>\r\n        <li>\r\n            <span>归属公司：</span>\r\n            <input type=\"text\" [(ngModel)]=\"company\" readonly *ngIf=\"!isEdits[1]\">\r\n            <select [(ngModel)]=\"selectedCompanyId\" *ngIf=\"isEdits[1]\">\r\n                <option *ngFor=\"let item of companys\" [value]=\"item.id\">{{item.name}}</option>\r\n            </select>\r\n            <button (click)=\"onClickResetCompany()\">修改</button>\r\n        </li>\r\n        <li>\r\n            <span>所在职位：</span>\r\n            <input type=\"text\" [(ngModel)]=\"position\" [readonly]=\"isPositionReadonly\" id=\"position\" [ngClass]=\"{'edit': isEdits[2]}\">\r\n            <button (click)=\"onClickResetPosition()\">修改</button>\r\n        </li>\r\n        <li>\r\n            <span>手机号码：</span><input type=\"text\" [(ngModel)]=\"allMes['mobile']\" readonly>\r\n        </li>\r\n        <li>\r\n            <span>实名认证：</span>\r\n            <span class=\"status\" [ngClass]=\"{'isPass': allMes['state'] === 'pass' ? true : false}\">\r\n                {{allMes['state'] === 'pass' ? '已激活' : '未认证'}}\r\n            </span>\r\n        </li>\r\n        <li>\r\n            <span>CA&nbsp;&nbsp;认证：</span>\r\n            <span class=\"status\" [ngClass]=\"{'isPass': allMes['prevCAState'] === 'activated' ? true : false}\">\r\n                {{allMes['prevCAState'] === 'activated' ? '已激活' : '未认证'}}\r\n            </span>\r\n            <span class=\"warning\" *ngIf=\"allMes['prevCAState'] === 'activated' ? false : true\">请使用手机进行认证！</span>\r\n        </li>\r\n        <li class=\"sure\" *ngIf=\"ifShowSubmitBtn\"><button (click)=\"onResetMesSubmit()\">确认</button></li>\r\n    </ul>\r\n</app-page-iframe>"
...
var PersonalCenterComponent = /** @class */ (function () {
    function PersonalCenterComponent(http, token) {
        this.http = http;
        this.token = token;
        this.allMes = {
            user: {}
    ...
    PersonalCenterComponent.prototype.ngOnInit = function () {
        ...
        this.NAV_INDEX = 4;
        // 获取所有公司
        this.http.get('/ucenter/rest/v2/services/ucenter_CompanyService/getAllCompany', { headers: { 'Authorization': "Bearer " + this.token._token } }).subscribe(function (data) {
            _this.companys = data;
            _this.getPersonalMes();
        });
    };
    PersonalCenterComponent.prototype.onClickResetName = function () {
        this.isNameReadonly = false;
        this.isEdits[0] = true;
        this.ifShowSubmitBtn = true;
        jquery__WEBPACK_IMPORTED_MODULE_2__('#name').focus();
    };
    PersonalCenterComponent.prototype.onClickResetCompany = function () {
        this.isEdits[1] = true;
        this.ifShowSubmitBtn = true;
        jquery__WEBPACK_IMPORTED_MODULE_2__('#company').focus();
    };
    PersonalCenterComponent.prototype.onClickResetPosition = function () {
        this.isPositionReadonly = false;
        this.isEdits[2] = true;
        this.ifShowSubmitBtn = true;
        jquery__WEBPACK_IMPORTED_MODULE_2__('#position').focus();
    };
    // 修改信息提交
    PersonalCenterComponent.prototype.onResetMesSubmit = function () {
        var _this = this;
        this.http.post('/ucenter/rest/v2/services/ucenter_UserService/updateClient2', {
            'name': this.name,
    ...
    // 获取用户信息
    PersonalCenterComponent.prototype.getPersonalMes = function () {
        var _this = this;
        this.http.get('/ucenter/rest/v2/services/ucenter_UserService/getCurrentClient', { headers: { 'Authorization': "Bearer " + this.token._token } }).subscribe(function (data) {
            _this.allMes = data;
            _this.name = data['name'];
            _this.company = data['company'];
            _this.position = data['user']['position'];
            _this.companys.forEach(function (element) {
                if (element.name === _this.company) {
                    _this.selectedCompanyId = element.id;
                }
            });
            _this.isNameReadonly = true;
            _this.isPositionReadonly = true;
            _this.isEdits.fill(false);
            _this.ifShowSubmitBtn = false;
        });
    };
    PersonalCenterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_http_api_service__WEBPACK_IMPORTED_MODULE_3__["HttpApi"], _shared_services_token_service__WEBPACK_IMPORTED_MODULE_1__["TokenService"]])
...
var ProjectInformationDetailComponent = /** @class */ (function () {
    function ProjectInformationDetailComponent(http, token) {
        this.http = http;
        this.token = token;
        this.projectDetail = {
            pics: [],
    ...
    ProjectInformationDetailComponent.prototype.ngOnInit = function () {
        ...
        //   ]
        // };
        this.http.get('/ucenter/rest/v2/services/ucenter_ProjectGroupService/getAllProjectGroups', { headers: { 'Authorization': "Bearer " + this.token._token } }).subscribe(function (data) {
            data.forEach(function (projectGroupItem) {
                projectGroupItem.projects.forEach(function (project) {
                    // if (project.id === routeID && project.status === 'IN_PROGRESS') {
                    if (project.id === routeID) {
                        if (project.images.length === 0) {
                            _this.projectDetail.pics.push('assets/images/no.jpg');
                        }
                        else {
                            project.images.forEach(function (item) {
                                _this.projectDetail.pics.push(project.entry + "images?id=" + item.id);
                            });
                        }
                        _this.projectDetail.detail.push(project.description ? project.description : '暂无信息');
                    }
                });
            });
        });
...
var ProjectInformationComponent = /** @class */ (function () {
    function ProjectInformationComponent(router, http, token) {
        this.router = router;
        this.http = http;
        this.token = token;
    ...
    // 项目搜索
    ProjectInformationComponent.prototype.searchProjects = function () {
        var _this = this;
        this.buildingPorjectsArr = [[]];
        if (this.searchProjectName === '') {
            this.projectGroups.forEach(function (projectGroupItem) {
                projectGroupItem.projects.forEach(function (project) {
                    if (project.status === 'IN_PROGRESS') {
                        _this.dataAnalyze(project);
                    }
                });
            });
        }
            ...
            this.projectGroups.forEach(function (projectGroupItem) {
                projectGroupItem.projects.forEach(function (project) {
                    if (project.status === 'IN_PROGRESS' && project.name.indexOf(_this.searchProjectName) !== -1) {
                        _this.dataAnalyze(project);
                    }
                });
            });
     ...
     */
    ProjectInformationComponent.prototype.dataAnalyze = function (project) {
...
module.exports = "<form action=\"\">\n  <input type=\"text\" placeholder=\"请输入手机号\" [(ngModel)]=\"phoneNum\" name=\"phoneNum\">\n  <label>\n    <input type=\"text\" placeholder=\"请输入验证码\" [(ngModel)]=\"yzmNum\" name=\"yzmNum\">\n    <a class=\"yzm\" (click)=\"getVerificationCode()\" *ngIf=\"!ifshowTimeOut\">{{yzmMes}}</a>\n    <a class=\"yzm\" *ngIf=\"ifshowTimeOut\">已发送（{{second}}）s</a>\n  </label>\n  <input type=\"password\" placeholder=\"请输入密码(8~20位，不能全是数字)\" [(ngModel)]=\"password\" name=\"password\"><br>\n  <input type=\"password\" placeholder=\"请再次输入密码\" [(ngModel)]=\"repassword\" name=\"repassword\"><br>\n  <button (click)=\"resetPwd($event)\">确定</button>\n</form>\n<div class=\"ui-g v-tooltop\">\n  <div class=\"ui-g-8\">\n  </div>\n  <div class=\"ui-g-4\">\n    <a (click)=\"returnSign()\">已有账号 立即登录</a>\n  </div>\n</div>"
...
/* harmony import */ var _services_http_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/http-api.service */ "./src/app/shared/services/http-api.service.ts");
...
var ForgetpwdDialogComponent = /** @class */ (function () {
    function ForgetpwdDialogComponent(http) {
        this.http = http;
    ...
    ForgetpwdDialogComponent.prototype.getVerificationCode = function () {
        var _this = this;
        var settings = {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_1__["ajax"](settings).done(function (response) {
            if (response === '验证码发送成功') {
                _this.ifshowTimeOut = !_this.ifshowTimeOut;
    ...
    ForgetpwdDialogComponent.prototype.resetPwd = function (e) {
        ...
        if (!this.phoneNum || this.phoneNum === '') {
            ...
            this.http.post('/ucenter/rest/v2/services/ucenter_UserService/resetPassword', {
                'code': this.yzmNum,
    ...
    ForgetpwdDialogComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_http_api_service__WEBPACK_IMPORTED_MODULE_2__["HttpApi"]])
...
module.exports = "<form action=\"\">\n  <input type=\"text\" placeholder=\"请输入手机号\" [(ngModel)]=\"phoneNum\" name=\"phoneNum\">\n  <label>\n    <input type=\"text\" placeholder=\"请输入验证码\" [(ngModel)]=\"yzmNum\" name=\"yzmNum\">\n    <a class=\"yzm\" (click)=\"getVerificationCode()\" *ngIf=\"!ifshowTimeOut\">{{yzmMes}}</a>\n    <a class=\"yzm\" *ngIf=\"ifshowTimeOut\">已发送（{{second}}）s</a>\n  </label>\n  <input type=\"password\" placeholder=\"请输入密码(8~20位，不能全是数字)\" [(ngModel)]=\"password\" name=\"password\"><br>\n  <input type=\"password\" placeholder=\"请再次输入密码\" [(ngModel)]=\"repassword\" name=\"repassword\"><br>\n  <label>\n    <input type=\"checkbox\" [(ngModel)]=\"isReadedMes\" name=\"isReadedMes\"><span>阅读并接受<a href=\"\">\n        《智慧建造用户协议》\n      </a></span>\n  </label>\n  <button (click)=\"regist($event)\">注册</button>\n</form>\n<div class=\"ui-g v-tooltop\">\n  <div class=\"ui-g-8\">\n  </div>\n  <div class=\"ui-g-4\">\n    <a (click)=\"returnSign()\">已有账号 立即登录</a>\n  </div>\n</div>"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_http_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/http-api.service */ "./src/app/shared/services/http-api.service.ts");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../environments/environment */ "./src/environments/environment.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var RegistDialogComponent = /** @class */ (function () {
    function RegistDialogComponent(http) {
        this.http = http;
    ...
    RegistDialogComponent.prototype.getVerificationCode = function () {
        var _this = this;
        if (!(/^1[3456789]\d{9}$/.test(this.phoneNum))) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_2__["ajax"](settings).done(function (response) {
                if (response === '验证码发送成功') {
                    _this.ifshowTimeOut = !_this.ifshowTimeOut;
                    var Timer_1 = setInterval(function () {
                        --_this.second;
    ...
    RegistDialogComponent.prototype.regist = function (e) {
        ...
        if (!this.phoneNum || this.phoneNum === '') {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_2__["ajax"](settings).done(function (data) {
                alert(data);
                if (data === '注册成功') {
                    _this.clickRegist.emit();
                }
            }).fail(function (err) {
                console.log(err);
            });
    ...
    RegistDialogComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_http_api_service__WEBPACK_IMPORTED_MODULE_1__["HttpApi"]])
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_token_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/token.service */ "./src/app/shared/services/token.service.ts");
/* harmony import */ var _services_cookie_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/cookie.service */ "./src/app/shared/services/cookie.service.ts");
/* harmony import */ var _services_http_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/http-api.service */ "./src/app/shared/services/http-api.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SignDialogComponent = /** @class */ (function () {
    function SignDialogComponent(token, cookie, http) {
        this.token = token;
        this.cookie = cookie;
        this.http = http;
    ...
    SignDialogComponent.prototype.sign = function (e) {
        var _this = this;
        e.preventDefault();
        this.http.post('/ucenter-portal/rest/v2/oauth/token', "grant_type=password&username=" + this.username + "&password=" + this.password, {
            'headers': {
                'Content-Type': 'application/x-www-form-urlencoded',
                'Authorization': 'Basic Y2xpZW50OnNlY3JldA==',
            }
        }).subscribe(function (data) {
            _this.cookie.setCookie('_idptickeToken', data['access_token']);
            _this.token._token = data['access_token'];
            _this.clickSign.emit();
        }, function (err) {
    ...
    SignDialogComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_token_service__WEBPACK_IMPORTED_MODULE_1__["TokenService"],
            _services_cookie_service__WEBPACK_IMPORTED_MODULE_2__["CookieService"],
            _services_http_api_service__WEBPACK_IMPORTED_MODULE_3__["HttpApi"]])
    ], SignDialogComponent);
...
var HttpApi = /** @class */ (function () {
    function HttpApi(http) {
        this.http = http;
        this.url = 'https://no_base_URL_configured';
    }
    HttpApi.prototype.setURL = function (url) {
        this.url = url;
    };
    HttpApi.prototype.getUrl = function (url) {
        return this.http.get(url);
    };
    HttpApi.prototype.syncGet = function (endpointArr) {
        var _this = this;
        var callbackArr = endpointArr.map(function (endpoint) {
            _this.url = endpoint.indexOf('.json') !== -1 ? _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].mockurl : _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiurl;
            var promise = new Promise(function (resolve, reject) {
                _this.http.get(_this.url + endpoint).subscribe(function (data) {
                    resolve(data);
                }, function (error) { return console.log(error); });
            });
            return promise;
    ...
    HttpApi.prototype.get = function (endpoint, options) {
        this.url = endpoint.indexOf('.json') !== -1 ? _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].mockurl : _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiurl;
        return this.http.get(this.url + endpoint, options);
    };
    HttpApi.prototype.post = function (endpoint, body, options) {
        this.url = endpoint.indexOf('.json') !== -1 ? _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].mockurl : _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiurl;
        return this.http.post(this.url + endpoint, body, options);
    };
    HttpApi.prototype.put = function (endpoint, body, options) {
        this.url = endpoint.indexOf('.json') !== -1 ? _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].mockurl : _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiurl;
        return this.http.put(this.url + endpoint, body, options);
    };
    HttpApi.prototype.delete = function (endpoint, options) {
        this.url = endpoint.indexOf('.json') !== -1 ? _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].mockurl : _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiurl;
        return this.http.delete(this.url + endpoint, options);
    };
    HttpApi.prototype.patch = function (endpoint, body, options) {
        this.url = endpoint.indexOf('.json') !== -1 ? _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].mockurl : _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiurl;
        return this.http.put(this.url + endpoint, body, options);
    };
    HttpApi = __decorate([
...
var environment = {
    production: false,
    apiurl: 'http://59.110.112.210:10000',
    mockurl: './assets/mock',
};
/*
